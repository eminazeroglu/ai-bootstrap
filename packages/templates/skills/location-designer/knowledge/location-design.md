...
- `image-prompt-engineer/knowledge/composition.md` → "Cinematic lived moments" (how to populate cells naturally, not as posed photos)
- `image-prompt-engineer/knowledge/character-anatomy.md` → "Face diversity" + "Period + place costume research" (every figure in the cell needs an anchor and varied face)
